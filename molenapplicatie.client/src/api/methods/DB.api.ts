 ...
 *
 * @tags DB
 * @name DBCallMolenResponses
 * @request GET:/api/DB/CallMolenResponses
 */
export async function dBCallMolenResponses(
  options: ApiMethodOptions<
    void,
    | HttpValidationProblemDetails
    | ProblemDetails
...
> {
  ...
  >(
    () =>
      ...
      >({
        ...params,
        path: `/api/DB/CallMolenResponses`,
        method: 'GET',
      }),
    {
      onSuccess: onSuccess ?? typedApiDefaultSuccessHandler,
 ...
 *
 * @tags DB
 * @name DBSaveMolenResponses
 * @request GET:/api/DB/SaveMolenResponses
 */
export async function dBSaveMolenResponses(
  options: ApiMethodOptions<
    void,
    | HttpValidationProblemDetails
    | ProblemDetails
...
> {
  ...
  >(
    () =>
      ...
      >({
        ...params,
        path: `/api/DB/SaveMolenResponses`,
        method: 'GET',
      }),
    {
      onSuccess: onSuccess ?? typedApiDefaultSuccessHandler,
 ...
 * @tags DB
 * @name DBtest2
 * @request GET:/api/DB/test2
 */
export async function dBtest2(
  options: ApiMethodOptions<
    void,
    | HttpValidationProblemDetails
    | ProblemDetails
