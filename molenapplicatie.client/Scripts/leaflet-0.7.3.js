...
(function (window, document, undefined) {
  ...
  L.Mixin.Events = {
    ...
    removeEventListener: function (types, fn, context) {
      ...
      if (
        L.Util.invokeEach(types, this.removeEventListener, this, fn, context)
      ) {
        return this;
      }
    ...
    removeClass: function (el, name) {
      if (el.classList !== undefined) {
        ...
        L.DomUtil._setClass(
          el,
          L.Util.trim(
            (" " + L.DomUtil._getClass(el) + " ").replace(
              " " + name + " ",
              " ",
            ),
          ),
  ...
  L.Map = L.Class.extend({
    ...
    fitBounds: function (bounds, options) {
      ...
      zoom =
        options && options.maxZoom ? Math.min(options.maxZoom, zoom) : zoom;
    ...
    _initPanes: function () {
      ...
      panes.objectsPane = this._createPane(
    ...
    unproject: function (point) {
      ...
      while (Math.abs(dphi) > tol && --i > 0) {
        ...
        dphi =
          Math.PI / 2 -
          2 *
            Math.atan(ts * Math.pow((1.0 - con) / (1.0 + con), 0.5 * eccent)) -
          phi;
        phi += dphi;
      }
  ...
  L.TileLayer.WMS = L.TileLayer.extend({
    ...
    getTileUrl: function (tilePoint) {
      ...
      return (
        url + L.Util.getParamString(this.wmsParams, url, true) + "&BBOX=" + bbox
      );
    },
  ...
  L.Marker = L.Class.extend({
    ...
    _initIcon: function () {
      var options = this.options,
        map = this._map,
        animation =
          map.options.zoomAnimation && map.options.markerZoomAnimation,
      ...
      toGeoJSON: function () {
        ...
        this.eachLayer(function (layer) {
          if (layer.toGeoJSON) {
            ...
            jsons.push(
              isGeometryCollection ? json.geometry : L.GeoJSON.asFeature(json),
            );
          }
        });
...
*/
  ...
  L.Map.Keyboard = L.Handler.extend({
    ...
    addHooks: function () {
      ...
      L.DomEvent.on(container, "focus", this._onFocus, this)
    ...
    removeHooks: function () {
      ...
      L.DomEvent.off(container, "focus", this._onFocus, this)
